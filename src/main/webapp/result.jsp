...
<div class="ui top attached segment">
    <div class="ui middle aligned two column grid">
        <div class="column">
            <h3 class="ui teal header">搜索&nbsp;<font color="red">${q}&nbsp;的结果</font></h3>
        </div>
        <div class="column right aligned">
            <!--h元素为block元素，会换行，使用自定义样式进行转换-->
            共<h2 class="ui orange header m-inline-block m-text-thin">${resultTotal}</h2>篇
        </div>
    </div>
</div>
...
<div class="ui teal attached segment">
    <c:choose>
        <c:when test="${blogList.size()==0}">
            <div class="content" style="text-align: center">未查找到结果,其换个关键字看看</div>
        </c:when>
        <c:otherwise>
